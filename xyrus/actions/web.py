...
def media_sounding(seconds: float = 0.8) -> bool:
    ...
    paused tab's session Active for a while). The song command's "pause the other audio" decides on this."""
...
def ensure_playing(video_title, trust_state=True, load_timeout=12.0) -> str:
    ...
    # share one session - the flag said "autoplay" for a new video that sat paused (user report, Sep 15-16 2026)
